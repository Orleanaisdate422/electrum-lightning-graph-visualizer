...
This is a plugin for the Electrum Bitcoin Wallet that visualizes the graph of Lightning Network nodes and channels contained in the wallets gossip database. It also allows to use the pathfinding functionality of Electrum to find a route and visualize it in the graph. It also supports A/B testing to compare pathfinding parameters.
